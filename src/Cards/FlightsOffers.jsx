  ...
  return (
    <div className="mb-4 shadow-md">
        ...
        <div className="flex-grow relative">
          ...
          <div className="flex items-center justify-between text-gray-600 shadow-lg h-28 rounded-lg px-2 mt-2">
            <div className="text-center">
              ...
              <p className="text-sm">Terminal {segment.origin_terminal ? segment.origin_terminal: "N/A"}</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm">Terminal {segment.destination_terminal ? segment.destination_terminal: "N/A"}</p>
            </div>
          </div>
      ...
      {showDeals && offer.moreClasses && offer.moreClasses.length > 0 && (
        <div className="mb-10 shadow-2xl border-t p-3">
          ...
          <ul className="space-y-2">
            {offer.moreClasses.map((deal, index) => (
              <li key={index} className="bg-gray-100 p-2 rounded shadow border">
                <p className="text-custom-gold">
                  <strong className="text-custom-green">Cabin Class:</strong>{" "}
                  {deal.cabin_class}
                </p>
                <p className="text-custom-gold">
                  <strong className="text-custom-green">Fare Brand:</strong>{" "}
